...
## Random Forest Model
The random forest model fit the subset of training data used as a test with **`r rf_acc`%** accuracy.
...
The gradiant boosting method fit the subset of training data used as a test with **`r gbm_acc`%** accuracy.
